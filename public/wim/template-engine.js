(function (root, factory) {
    ...
    function buildHtml(templateHtml, rawData) {
        ...
        html = html.replace(/<meta name="description" content="[^"]*">/, `<meta name="description" content="Undangan Pernikahan Digital ${attrEscape(data.coupleName)}">`);
    ...
    function buildScript(templateScript, rawData) {
        ...
        script = script.replace(/const audio = new Audio\('[^']*'\);/, `const audio = new Audio(${JSON.stringify(data.audioUrl || "")});`);
