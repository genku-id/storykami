...
// ============================================================
var AUDIO_URL = 'https://youtu.be/06-XXOTP3Gc?si=NwCflHTNMIW7qj1Y';
var AUDIO_START = 0;
// ============================================================
...
if (_ytMatch) {
    ...
    // Callback GLOBAL — harus di luar setTimeout agar tidak terlewat
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (btnOpen) {
        btnOpen.addEventListener('click', function() {
            ...
            // Mulai putar musik — ini adalah user gesture sehingga browser mengizinkan
            _playAudio();
        });
    }
    ...
    // Countdown
    var targetDate = new Date("2027-01-14T09:00:00+07:00").getTime();
