      ...
      <div className="floral-theme-wrapper">
        ...
        <div id="main-content" className="main-content">
          ...
          {data.show_hal8 !== false && (
            <section id="closing" className="section closing-section text-center" style={{ backgroundImage: `url(${data.hal2_fotoCouple || '/demo/template-floral1/assets/images/couple.png'})` }}>
          ...
          <footer className="footer bg-sage-dark text-white text-center">
              <img src="/demo/template-floral1/assets/images/logo.png" alt="StoryKami" className="footer-logo" />
              <h3>STORYKAMI</h3>
