...
export default function DashboardLayout({ children }) {
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', background: 'var(--bg-primary)' }}>
        ...
        <div className="wim-mobile-header">
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            <button className="mob-menu-btn" onClick={() => setSidebarOpen(true)} style={{
              ...
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="3" y1="12" x2="21" y2="12"/><line x1="3" y1="6" x2="21" y2="18"/></svg>
            </button>
      ...
      {/* ===== MAIN CONTENT ===== */}
      <main className={!isEditor ? "wim-page-offset" : ""} style={{ flex: 1, minWidth: 0, display: 'flex', flexDirection: 'column', overflowX: 'hidden' }}>
        {children}
      </main>
    </div>
  );
